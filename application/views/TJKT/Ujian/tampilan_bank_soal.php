                                    ...
                                    <td>
                                        <h5 class="text-center">
                                            <a class="btn btn-primary btn-sm text-uppercase font-weight-bolder"
                                                href="<?= base_url() ?>Dashboard_tkj/upload_banksoal/<?= $row['id_bank_soal'] ?>">UPLOAD</a>
                                            <a class="btn btn-success btn-sm text-uppercase font-weight-bolder"
                                                href="<?= base_url() ?>Dashboard_tkj/detail_banksoal/<?= $row['id_bank_soal'] ?>">DETAIL</a>
                                            <a class="btn btn-danger btn-sm text-uppercase font-weight-bolder"
                                                href="<?= base_url() ?>Dashboard_tkj/hapus_banksoal/<?= $row['id_bank_soal'] ?>">HAPUS</a>
                                        </h5>
                                    </td>≈
                            </tr>
                        <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url() ?>Dashboard_tkj/simpan_bank_soal" method="post">
                    ...
                    <div class="row mb-3 text-center">
                        <div class="col-md">
                            <div class="form-check form-check-inline">
                                ...
                                <label
                                    class="form-check-label text-uppercase font-weight-bolder text-dark text-text-uppercase font-weight-bolder text-dark">TJKT</label>
                            </div>
                            <div class="form-check form-check-inline">
