...
class Dashboard_dkv extends MY_Controller
{
    ...
    public function buat_mapel_jadwal($id_mapel)
    {
        ...
        $isi2['title'] = 'CBT | Administrator';
        $isi['content'] = 'DKV/Ujian/tampilan_buat_jadwal';
        $this->load->view('templates/header', $isi2);
        $this->load->view('DKV/tampilan_dashboard', $isi);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_jadwal($id_jadwal)
    {
        ...
        $isi2['title'] = 'CBT | Administrator';
        $isi['content'] = 'DKV/Ujian/tampilan_edit_jadwal';
        $this->load->view('templates/header', $isi2);
        $this->load->view('DKV/tampilan_dashboard', $isi);
        $this->load->view('templates/footer');
    }
    ...
    public function upload_banksoal($id_bank_soal_temp)
    {
        ...
        $isi2['title'] = 'CBT | Administrator';
        $isi['content'] = 'DKV/Ujian/tampilan_bank_soal_upload';
        $this->load->view('templates/header', $isi2);
        $this->load->view('DKV/tampilan_dashboard', $isi);
        $this->load->view('templates/footer');
    }
